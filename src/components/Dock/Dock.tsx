...
const Dock: React.FC = () => {
  ...
  const { openApp, openApps, setActiveApp, activeApp } = useAppsStore((state) => ({
          ...
          >
            <button
              ...
              style={{
                ...
                boxShadow: isActive ? '0 0 12px rgba(0, 122, 255, 0.4)' : 'none',
              }}
            ...
            >
              <img
                ...
                onError={(e) => {
                  ...
                  (e.target as HTMLImageElement).src = '/app-icons/finder/256.png';
                }}
              />
