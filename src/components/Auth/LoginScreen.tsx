...
const LoginScreen: React.FC = () => {
  ...
  return (
    <div style={{
      width: '100vw',
      height: '100vh',
      background: 'linear-gradient(135deg,rgb(46, 46, 47) 0%,rgb(0, 0, 0) 100%)',
      display: 'flex',
      alignItems: 'center',
      ...
      <div style={{
        ...
        padding: '60px 50px',
        textAlign: 'center',
        boxShadow: '0 32px 64px rgba(0, 0, 0, 0.25), 0 0 0 1px rgba(255, 255, 255, 0.3)',
        minWidth: '400px',
        position: 'relative',
        zIndex: 1,
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minHeight: '80px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '16px' }}>
            ...
            <span style={{ 
              ...
              {isLoading ? 'Redirecting to secure login...' : 'Initializing secure connection...'}
            </span>
          </div>
