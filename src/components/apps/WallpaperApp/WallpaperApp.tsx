...
const WallpaperApp: React.FC = () => {
  ...
  const filteredWallpapers = availableWallpapers.filter(
    (wallpaper) =>
  ...
  return (
    ...
    >
          ...
          {(["all", "Fugir", "nature", "artistic"] as const).map((category) => (
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                backgroundColor:
                  selectedCategory === category ? "#007aff" : "#f1f3f4",
      ...
      >
        {isDynamic
          ? "Dynamic wallpapers change throughout the day"
          : "Static wallpaper selected"}
      </div>
    </div>
  );
};
